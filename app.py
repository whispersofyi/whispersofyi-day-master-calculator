...
# CSS styling to match your aesthetic - FIXED
st.markdown("""
<style>
...
# [Rest of your code remains exactly the same - DAY_MASTER_DATA, functions, and main application logic]
# ... (the rest of your code with DAY_MASTER_DATA, validate_input, calculate_day_master, create_four_pillars functions)
...
DAY_MASTER_DATA = {
    ...
    # [Rest of the DAY_MASTER_DATA dictionary...]
    # ... (include all the other day masters: 乙, 丙, 丁, 戊, 己, 庚, 辛, 壬, 癸)
}
