...
# CSS styling to match your aesthetic with modification for h1 color black
st.markdown("""
<style>
...
h1 {
    ...
    padding-bottom: 1rem;
    color: black;  /* Title now black for visibility */
}
...
# Day Master data (same as your original dictionary, abbreviated here)
DAY_MASTER_DATA = {
    # Your full DAY_MASTER_DATA dict here exactly as before without change
    # ...
}
