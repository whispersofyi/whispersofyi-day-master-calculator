...
if submit_button:
    ...
    st.caption("“&copy; 2025 Whispers of YI — Code under MIT, Guides under CC BY-NC-ND 4.0 The flame flickers in wind, but never forgets it burns.” — Understanding your Day Master is understanding the element that never changes within you.")
